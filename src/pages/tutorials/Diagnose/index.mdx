...
In this case, you should see the **Triggering Event** and a few **Related Events**.   The **Triggering Event** is the first event that starts to impact a service or a website.
