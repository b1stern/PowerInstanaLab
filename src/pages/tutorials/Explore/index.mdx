...
Login as apmdemo-1@yahoo.com and the password provided by your instructor.
...
Explore the Host Agents on IBM i, AIX, and Linux on Power by selecting the Node and then selecting the **Open Dashboard** button.
  ![](images/IBMi.png)
